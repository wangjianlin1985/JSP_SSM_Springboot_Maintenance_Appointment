...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">汽车维修网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Barber/frontlist">维修人员介绍</a></li>
                <li><a href="<%=basePath %>ServiceItem/frontlist">维修项目介绍</a></li>
                
                <li><a href="<%=basePath %>Paiban/frontlist">维修人员排班</a></li>
