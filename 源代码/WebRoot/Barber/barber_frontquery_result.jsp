...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Barber/frontlist">维修人员信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Barber/barber_frontAdd.jsp" style="display:none;">添加维修人员</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<barberList.size();i++) {
            		...
            		Barber barber = barberList.get(i); //获取到维修人员对象
            		String clearLeft = "";
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;维修人员信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="barber_barberId_edit" class="col-md-3 text-right">维修人员id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="barber_barberId_edit" name="barber.barberId" class="form-control" placeholder="请输入维修人员id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="barber_barberAge_edit" class="col-md-3 text-right">维修人员年龄:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="barber_barberAge_edit" name="barber.barberAge" class="form-control" placeholder="请输入维修人员年龄">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="barber_barberPhoto_edit" class="col-md-3 text-right">维修人员照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="barber_barberDesc_edit" class="col-md-3 text-right">维修人员介绍:</label>
		  	 <div class="col-md-9">
			 	<textarea name="barber.barberDesc" id="barber_barberDesc_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="barber_barberMemo_edit" class="col-md-3 text-right">维修人员备注:</label>
		  	 <div class="col-md-9">
			    <textarea id="barber_barberMemo_edit" name="barber.barberMemo" rows="8" class="form-control" placeholder="请输入维修人员备注"></textarea>
			 </div>
		  </div>
		</form> 
...
<script>
//实例化编辑器
var barber_barberDesc_edit = UE.getEditor('barber_barberDesc_edit'); //维修人员介绍编辑器
